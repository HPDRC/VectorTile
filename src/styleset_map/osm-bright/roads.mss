...
#roads_high::outline[zoom>=13],
#tunnel[render='1_outline'][zoom>=13],
#bridge[render='1_outline'][zoom>=13]{
  /* -- colors & styles -- */
  line-cap: round;
  [bridge=1],
  [tunnel=1] {
...
#roads_high[zoom>=12],
#tunnel[render='3_inline'][zoom>=12],
#bridge[render='3_inline'][zoom>=12]{
...
#tunnel[render='2_line'][zoom>=14],
#bridge[render='2_line'][zoom>=14]{
  /* -- colors & styles -- */
  [stylegroup='noauto'] {
    line-color: @land;
    line-width: 0;

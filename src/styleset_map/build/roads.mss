...
#roads_med[zoom>=9][zoom<=11] {
  ...
  [type='primary'] { line-color: @standard_case; }
 [type='secondary'] { line-color:@standard_case; }
  [zoom=9] {
...
@rdz15_maj: 6;   @rdz15_med: 5;   @rdz15_min: 2.5;
@rdz16_maj: 10;  @rdz16_med: 11; @rdz16_min: 4;
@rdz17_maj: 14;  @rdz17_med: 19;  @rdz17_min: 10.5;
@rdz18_maj: 20;  @rdz18_med: 21;  @rdz18_min: 13;

/* ---- Casing ----------------------------------------------- */

  #roads_med::outline[zoom=11][zoom=12] {
    [type='motorway']{
    line-color: @motorway_case_sm;
    line-width:10;}
//     [bridge=1] { line-color: @motorway_case_sm}
} 
...
//    [bridge=1] { line-color: @secondary_case * 0.8; }
  ...
  /* -- widths of casing -- */
  [zoom=11] {
    [stylegroup='motorway'] { line-width: @rdz11_maj+10; }
    [stylegroup='mainroad'] { line-width: @rdz11_med+10;  }
  ...
  [zoom=12] {
 //   [stylegroup='motorway'] { line-width: @rdz12_maj + 10; }
    [stylegroup='mainroad'] { line-width: 10; }
    [stylegroup='minorroad']{ line-width: 0; }
    /* No minor bridges yet */
    [stylegroup='service']  { line-width: 0; }
    [stylegroup='noauto']   { line-width: 0; }
  ...
  [zoom=13] {
    ...
    [stylegroup='mainroad'] { line-width: @rdz13_med + 1; }
    [stylegroup='minorroad']{ line-width: 0; }
    /* No minor bridges yet */
    [stylegroup='service']  { line-width: 0; }
    [stylegroup='noauto']   { line-width: 0; }
  ...
  [zoom=15] {
    [stylegroup='motorway'] { line-width: @rdz15_maj + 1.4; }
    [stylegroup='mainroad'] { line-width: @rdz15_med + 4.2; }
    [stylegroup='minorroad']{ line-width: @rdz15_min + 1.3; }
    [stylegroup='service']  { line-width: 0; }
    [stylegroup='noauto']   { line-width: 0;  }
  ...
  [zoom=16] {
    ...
    [stylegroup='mainroad'] { line-width: @rdz16_med + 1.3; }
    [stylegroup='minorroad']{ line-width: @rdz16_min + 1.3; }
    [stylegroup='service']  { line-width: 0; }
    [stylegroup='noauto']   { line-width: 0; }
  ...
  [zoom>=17] {
    ...
    [stylegroup='service']  { line-width: 0}
//   [stylegroup='service']  { line-width: @rdz17_min / 3 + 1.5; }
    [stylegroup='noauto']   { line-width: 1; }
    [stylegroup='railway']  { line-width: 3 + 4; } // 3 + 4
  }
  [zoom>=18] {
    [stylegroup='motorway'] { line-width: @rdz18_maj + 2; }
    ...
    [stylegroup='noauto']   { line-width: 2.5; }
    [stylegroup='railway']  { line-width: 4 + 6; }
  }
}

  /* -- colors & styles of roads -- */


#roads_high[zoom>=12][zoom<=20],
#tunnel[render='3_inline'][zoom>=12][zoom<=20],
#bridge[render='3_inline'][zoom>=12][zoom<=20]{

  line-color: @standard_fill;
  
//  [type='path'] {line-color:red; line-width:10;}
//  [type='footway'] {line-color:blue; line-width:10;}
//  [type='track'] {line-color:green; line-width:10;}
//  [type='cycleway'] {line-color:pink; line-width:10;}
//  [type='pedestrian'] {line-color:pink; line-width:10;}
  
  [type='motorway'],
  [type='motorway_link'] {
    line-color: @motorway_fill;
    [tunnel=1] { line-color: lighten(@motorway_fill, 10%); }
    [zoom>=11][zoom<=12] {line-color: @standard_case;}
        }
  [type='trunk'],
  [type='trunk_link'] {
  ...
  [type='primary_link'] {
    ...
    [zoom>=11][zoom<=12] {line-color:@standard_case;}
//    [zoom>=11][zoom<=12] {line-color:lighten(@standard_case, 50%);}
  }
  [type='secondary'],
  [type='secondary_link'] {
  ...
  [stylegroup='minorroad'] {
    ...
    [zoom>=12][zoom<15]{
    [stylegroup='minorroad'],
 {  line-color: lighten(@standard_case, 15%); }
    } 
  
  [zoom>=14][zoom<=17]{
    [stylegroup='noauto'],
    [stylegroup='service'] {line-color: @standard_case; }
    } 
  ...
  [stylegroup='noauto'] {
    line-join: round; 
   [zoom>=15][zoom<=17] { line-color: darken(@noauto_line,10%); }
    [zoom>=17] { line-color:@noauto_line;}
  }
  ...
  [zoom=14] {
    ...
    [stylegroup='minorroad']{ line-width: @rdz14_min * 0.8;}
  ...
  [zoom=15] {
    ...
    [stylegroup='noauto']   { line-width: 0.5; }
  ...
  [zoom=17] {
    ...
    [stylegroup='service']  { line-width: @rdz17_min / 5; }
//   [stylegroup='service']  { line-width: @rdz17_min / 3; }
    [stylegroup='noauto']   { line-width: 1.3 ; line-dasharray: 5,2; }
//    [stylegroup='noauto']   { line-width: @rdz17_min / 4; line-dasharray: 2,2; }
  ...
  [zoom>=18] {
    ...
    [stylegroup='noauto']   { line-width:2.5 ; line-dasharray: 6,3; }

...
#define PLANET_INTERVAL (30 * 24 * 60 * 60)
...
// liangdong: changed for faster response time, but lower tile serving capability. Maybe changed to a better value in the future
#define METATILE (4)
//#undef METATILE
...
#define REQ_LIMIT (128)
#define DIRTY_LIMIT (4000)
